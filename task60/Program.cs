...
Console.Clear();
int matrix1 = InputInt("Введите размерность 1: ");
int matrix2 = InputInt("Введите размерность 2: ");
int matrix3 = InputInt("Введите размерность 3: ");
int countNums = 99;

if (matrix1 * matrix2 * matrix3 > countNums)
{
    Console.Write("Массив слишком большой");
    return;
}

int[,,] resultNums = Create3DMassive(matrix1, matrix2, matrix3);
